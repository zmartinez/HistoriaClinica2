...
import co.edu.uelbosque.sistemas.swiii.c3.historiaclinica.config.*;
...
@ComponentScan(basePackages = {
    "co.edu.unbosque",
//    "co.edu.unbosque.controllers"
})
@EnableJpaRepositories("co.edu.unbosque.repositorio")
@PropertySource(value = {"classpath:postgresVagrant.properties"})
public class HistoriClinicaConfigQA {
